    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView.builder(
            itemCount: playdb[intindex!].playlistsongs.length,
            shrinkWrap: true,
            itemBuilder: ((context, index) {
              return ListTile(
                onTap: () async {
                  final songdb = playdb[intindex!].playlistsongs;
                  ...
                  await player.open(Audio.file(
                    playdb[intindex!].playlistsongs[index].songurl!,
                  ));
                },
                leading: ClipRRect(
                  ...
                  child: QueryArtworkWidget(
                    ...
                    keepOldArtwork: true,
                    id: playdb[intindex!].playlistsongs[index].id!,
                    type: ArtworkType.AUDIO,
                  ),
                ),
                title: Text(
                  playdb[intindex!].playlistsongs[index].songname!,
                  style: GoogleFonts.rubik(fontSize: 20, color: Colors.white),
                ),
                subtitle: Padding(
                  padding: EdgeInsets.only(bottom: vww * 0.035),
                  child: Text(
                    playdb[intindex!].playlistsongs[index].artist!,
